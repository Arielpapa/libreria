...
<head>
  ...
  <!-- Bootstrap 3.3.7 -->
  {{-- <link rel="stylesheet" href="http://localhost/librerias-L9/public/bower_components/bootstrap/dist/css/bootstrap.min.css"> --}}
...
$('.table').on('click','.QuitarLibro', function(){
  ...
  Swal.fire({
    ...
    if(result.isConfirmed){
      window.location = "{{ url('Libro-Q/') }}/"+Lid;
    }
  })
});
